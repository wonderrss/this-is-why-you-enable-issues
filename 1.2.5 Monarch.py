...
Polygon(120,75,125,100,180,150,145,85, fill="orange")
Polygon(70,100,100,140,160,165,125,115, fill="orange")
Polygon(70,155,105,155,140,180,90,185, fill="orange")
...
### Place Your Code Here ###
Polygon(240,230,280,210,320,225,285,240, fill= "white")
Polygon(220,250,255,270,295,270,275,245, fill="white")
Polygon(290,245,320,235,325,250,305,265, fill="white")
