...
Label('THE TALE OF', 100, 75, fill="lightSkyBlue", font="arial",size=20, bold=True,italic=True)
Label('A PROGRAMMER',100,125, fill="lightSkyBlue", font="arial",size=20, bold=True,italic=True)
...
### Modify Your Code Here ###
Label('I do not get your code',300,40,fill="black", font="monospace")
...
### Modify Your Code Here ###
Label("Neither do I", 100,240,fill="black", font="monospace")
...
### Modify Your Code Here ###
Label("But it works!!", 300,240, fill="black", font="monospace")
